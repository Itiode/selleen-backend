...
const prodCtrl = __importStar(require("../controllers/product/product"));
const prodReviewCtrl = __importStar(require("../controllers/product/review"));
...
router.post("/:productId/review", auth_1.default, prodReviewCtrl.addReview);
